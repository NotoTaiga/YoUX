    ...
    masterData: [
      {
        ...
        img: null,
        child: ['学生証', 'MyColor', '捗り度', '学生APP 名刺管理', 'プライベート名刺交換', '学生APP リアルタイム教科書', '学生APP リアルタイムPDF', '学生APP デスクcloud編集', '学生APP デスクプラグインの申請', '学生APP ラッキーDay', 'Day ToDo',]
      }, {
        id: 23,
        name: '学生証',
        place: ['学生APP'],
        ...
        text: ["mycolorの変わりにくい色として設定されているメンタル色はその人の人柄を現したいと考えています。",
          ...
          "名刺では実際に交換をし話してみた相手に対して色の投票を行うことが出来、授業では生徒間の距離が近い又はグループワークがある授業、主にアクティブラーニングや英語の授業などから情報収集し、期末評価として色を適用します。",
        ...
        text: ["授業で主に使われるものです。",
          ...
          "他にも自分以外の生徒がマークしたものも見ることができ、授業中に出てきたサイトのURLを入力することなども可能です。",
